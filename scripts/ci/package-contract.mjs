...
const targetDefinitions = [
  {
    ...
    platform: 'win32',
    arch: 'x64',
    artifactName: 'miowork-package-win32-x64',
  ...
  },
  {
    ...
    platform: 'win32',
    arch: 'arm64',
    artifactName: 'miowork-package-win32-arm64',
  ...
  },
  {
    ...
    platform: 'darwin',
    arch: 'x64',
    artifactName: 'miowork-package-darwin-x64',
  ...
  },
  {
    ...
    platform: 'darwin',
    arch: 'arm64',
    artifactName: 'miowork-package-darwin-arm64',
